...
public class c_Appointments extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jSeparator2.setBounds(660, 210, 140, 10);
        ...
        jSeparator1.setBounds(200, 450, 90, 10);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
       ...
       DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
        dtm.setRowCount(0);
        try {
            ResultSet rs = DB.getData("select* from appointments");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            DB.setData("update appointments set CID='"+CID+"', EID='"+EID+"',date='"+date+"', from='"+from+"', to='"+to+"'");
